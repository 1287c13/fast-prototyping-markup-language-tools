function uncoloredButton1cRenderer(props) {
    return `
        <div
            class="yellow-button draggable uncoloredbutton1c element-main-wrapper drag-handle" id="${props.id || generateElementID()}"
            onmouseout="this.querySelectorAll('.uncoloredbutton1c-hover-visible').forEach((e)=>{e.style.display='none'})"
            onmouseover="this.querySelectorAll('.uncoloredbutton1c-hover-visible').forEach((e)=>{e.style.display='flex'})"
            onmouseenter="handleOpacityOnmouseenter(this)"
            onmouseleave="handleOpacityOnmouseout(this)"
            style="position: absolute; top: ${props['top']}; left: ${props['left']}; font-weight: 700; font-size: 15px;
        ...
        >
            <div class="uncoloredbutton1c-hover-visible hide-command-senitive" 
            ...
            >
                ...
                <div class="settings-wrapper" style="width: 220px; z-index: 9999;">
                    ...
                    <div class="settings-panel"
                         style="flex-direction: column; display: none; font-family: 'JetBrains Mono', serif;"
                    >
                        <div style="display: flex; flex-direction: row-reverse;">
                            <button
                                    style="font-size: 10px; margin-top: 5px; font-family: 'JetBrains Mono', serif;
                                        ...
                                        border-radius: 2px;"
                                    onclick="this.closest('.uncoloredbutton1c').remove()"
            ...
            >
                ${getResizer('hor', '3px', '3px', 'element-textarea', 'relative', 
                            '', true, '#555')}
                <textarea
                    class="element-textarea uncoloredbutton1c-name-resize-textarea"
                    ...
                    style="background-color: transparent; color: #4A4A4A; font-family: 'Arial', serif; font-weight: 400;
                        ...
                        width: ${props['nameResizeWidth']}; resize: none; outline: none; margin: 1px 0 0 10px;"
                >${props['name']}</textarea>
            </div>
        </div>
    `;
...
function uncoloredButton1c(
  ...
  markupID = generateElementID()
    ...
    document.querySelector(`#form-1c-${id}`).innerHTML += uncoloredButton1cRenderer(props);
}